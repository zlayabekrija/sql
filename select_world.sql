...
SELECT name,(population/1000000) AS pop_mil FROM world WHERE continent = 'South America';
...
SELECT name,ROUND(population/1000000,2) AS population_mil,ROUND(GDP/1000000000,2) AS GDP FROM world WHERE continent = 'South America'; 
